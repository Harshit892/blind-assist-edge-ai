...
try:
    ...
    labels = ["clear_path", "door", "human", "obstacle", "stairs"]
...
try:
    while True:
        ...
        # OpenMV's default net.predict() does a center crop if we don't do this!
        ...
        if frame_count % 30 == 0:
            ...
            print("[FPS: %.1f | Avg: %.1fms]" % (fps, avg_ms))
            fps_start_time = time.ticks_ms()

        time.sleep_ms(DETECTION_INTERVAL_MS)
